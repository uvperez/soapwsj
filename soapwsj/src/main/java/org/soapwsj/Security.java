...
import static org.soapwsj.SoapConstants.*;
import static org.soapwsj.MiscUtils.*;
    ...
    public static class Builder {
        ...
        public Builder keyStoreUrl(String value) {
            ...
            try {
                ...
                throw new SoapException(String.format("URL [%s] is malformed", value), ex);
            }
        }
        ...
        private KeyStore initKeyStore(KeyStore keyStore, URL keyStoreUrl, String keyStoreType, char[] keyStorePassword) {
            ...
            if (keyStore != null && keyStorePropertiesDefined) {
                throw new SoapException("Specify either a keyStore | trustStore instance or properties required to load one " +
                        "(url, type, password)");
            }
            if (keyStoreUrl != null) {
                try {
                    ...
                    throw new SoapException("KeyStore setup failed", e);
                } catch (IOException e) {
                    throw new SoapException("KeyStore setup failed", e);
                }
            }
